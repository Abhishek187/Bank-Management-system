...
#function to inserting records of account holders
def Insert():
    while True:
...
#function to delete data from a bank account
def Delete():
    try:
        cmd="select * from sbi "
        mycursor.execute(cmd)
...
#function to debit money to an account
def Debit():
    try:
        cmd=" select * from sbi"
        mycursor.execute(cmd)
...
#function to credit money to an account
def Credit():
    try:
        cmd=" select * from sbi"
        mycursor.execute(cmd)
